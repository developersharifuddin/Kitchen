...
<div class="content">
        <div class="container-fluid">
          <div class="row">
            <div class="col-md-12">
            <a href="{{ route('sub_category.create') }}" class="btn btn-primary">Add sub_category</a>
              <div class="card">
                  ...
                  <div class="table-responsive">
                    <table id="example" class="table table-striped table-bordered" >
                      ...
                      <tbody>
                         ...
                         @foreach($subscategories as $key => $category)
                      <tr>
                        <td> {{$key+1}} </td>
                        ...
                        <td class="td-actions text-left">
                                  ...
                                  <a href="{{ route('sub_category.edit',$category->id)}}" style="float:left">
                                  <button type="button" rel="tooltip" title="Edit Task" class="btn btn-primary btn-link btn-sm">
                                  <i class="material-icons">edit</i>
                                  </button></a>
   
                                   <form id="delete-form-{{$category->id}}" action="{{route('sub_category.destroy', $category->id)}}" 
