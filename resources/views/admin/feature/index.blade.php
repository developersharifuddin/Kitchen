                        ...
                        <tr>
                          ...
                          <td>  {{$feature->slug}} </td>
                                ...
                                <td class="td-actions text-left">
                                  ...
                                  <a href="{{ route('feature.edit',$feature->id)}}" style="float:left">
                                  <button type="button" rel="tooltip" title="Edit Task" class="btn btn-primary btn-link btn-sm">
                                  <i class="material-icons">edit</i>
                                  </button></a>
   
                                   <form id="delete-form-{{$feature->id}}" action="{{route('feature.destroy', $feature->id)}}" 
                                  ...
                                  <a href="{{ route('feature.show',$feature->id)}}" style="float:left;display:none" style="margin-left:20px">
